...
import main.java.com.semicolon.africa.model.Stack.StackMethods;
...
public class StackMethodTest {
    ...
    @Test
    public void pushTwice_popTwo_stackIsEmptyTest() {
        StackMethods strings = new StackMethods(4);
        assertTrue(strings.isEmpty());
        strings.push("G - String");
    ...
    @Test
    public void shouldThrowUnderFlowException_whenEmptyStackIsPoppedTest() {
        StackMethods strings = new StackMethods(4);
        assertTrue(strings.isEmpty());
        assertThrows(MyStack.StackUnderFlowException.class, ()-> strings.pop());
    }
